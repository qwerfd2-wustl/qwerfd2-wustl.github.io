...
export type CommandNames = 'fb' | 'tw' | 'gm' | 'gd' | 'yt' | 'gh' | 'rd' | 'ln' | 'tv' | 'dg' | 'bd' | 'cg' | 'so' |
                           'zh' | 'wiki' | 'pm' | '$' | 'DEFAULT';
...
export const COMMANDS: {[CommandNames] : CommandType} = {
    ...
    tw: {
        ...
        searchurl: "https://twitter.com/search?q=abc"
    },
    gm: {
        name: "Gmail",
    ...
    cg: {
        ...
        searchurl: "https://www.chegg.com/search?q="
    },
    so: {
        name: "StackOverflow",
    ...
    pm: {
        ...
        searchurl: "https://platinmods.com/search/51886556/?q="
    },
    DEFAULT: {
